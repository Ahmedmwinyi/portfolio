    ...
    return (
        <div className='bg-black text-white text-center py-16'>
            ...
            <p className='mt-4 text-lg text-gray-300 px-4 md:px-32'>
                I specialize in building modern and responsive web & mobile application.
            </p>
            <div className='mt-8 space-x-4'>
                <button
                    className='bg-gradient-to-r from-gray-700 to-green-500 text-white hidden md:inline 
